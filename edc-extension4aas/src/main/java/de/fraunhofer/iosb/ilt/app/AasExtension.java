 ...
 */
package de.fraunhofer.iosb.ilt.app;

import de.fraunhofer.iosb.ilt.aas.lib.model.impl.Registry;
import de.fraunhofer.iosb.ilt.aas.lib.model.impl.Service;
import de.fraunhofer.iosb.ilt.api.PublicApiManagementService;
import de.fraunhofer.iosb.ilt.api.model.HttpMethod;
import de.fraunhofer.iosb.ilt.app.aas.EnvironmentToAssetMapper;
import de.fraunhofer.iosb.ilt.app.aas.agent.impl.RegistryAgent;
import de.fraunhofer.iosb.ilt.app.aas.agent.impl.ServiceAgent;
import de.fraunhofer.iosb.ilt.app.controller.AasController;
import de.fraunhofer.iosb.ilt.app.controller.ConfigurationController;
import de.fraunhofer.iosb.ilt.app.controller.SelfDescriptionController;
import de.fraunhofer.iosb.ilt.app.edc.CleanUpService;
import de.fraunhofer.iosb.ilt.app.edc.asset.AssetRegistrar;
import de.fraunhofer.iosb.ilt.app.edc.contract.ContractRegistrar;
import de.fraunhofer.iosb.ilt.app.model.aas.registry.RegistryRepository;
import de.fraunhofer.iosb.ilt.app.model.aas.registry.RegistryRepositoryUpdater;
import de.fraunhofer.iosb.ilt.app.model.aas.service.ServiceRepository;
import de.fraunhofer.iosb.ilt.app.model.aas.service.ServiceRepositoryUpdater;
import de.fraunhofer.iosb.ilt.app.model.configuration.Configuration;
import de.fraunhofer.iosb.ilt.app.pipeline.Pipeline;
import de.fraunhofer.iosb.ilt.app.pipeline.PipelineStep;
import de.fraunhofer.iosb.ilt.app.pipeline.helper.CollectionFeeder;
import de.fraunhofer.iosb.ilt.app.pipeline.helper.Filter;
import de.fraunhofer.iosb.ilt.app.pipeline.helper.InputOutputZipper;
import de.fraunhofer.iosb.ilt.app.pipeline.helper.MapValueProcessor;
import de.fraunhofer.iosb.ilt.app.sync.Synchronizer;
import de.fraunhofer.iosb.ilt.app.util.InetTools;
import de.fraunhofer.iosb.ilt.app.util.VariableRateScheduler;
...
import static de.fraunhofer.iosb.ilt.app.controller.SelfDescriptionController.SELF_DESCRIPTION_PATH;
import static de.fraunhofer.iosb.ilt.app.pipeline.PipelineFailure.Type.FATAL;
import static de.fraunhofer.iosb.ilt.app.util.InetTools.getSelfSignedCertificate;
import static de.fraunhofer.iosb.ilt.app.util.InetTools.isConnectionTrusted;
...
public class AasExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        if (Configuration.getInstance().isExposeSelfDescription()) {
            publicApiManagementService.addEndpoints(List.of(new de.fraunhofer.iosb.ilt.api.model.Endpoint(SELF_DESCRIPTION_PATH, HttpMethod.GET,
                    Map.of())));
        }
