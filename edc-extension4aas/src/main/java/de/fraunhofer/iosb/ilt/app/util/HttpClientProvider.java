 ...
 */
package de.fraunhofer.iosb.ilt.app.util;
...
public class HttpClientProvider {
    ...
    public static Result<OkHttpClient> clientFor(@NotNull Certificate[] certificateChain) {
        ...
        try {
            ...
            return Result.failure("%s trying to initialize SSL context: %s".formatted(keyManagementException.getClass().getSimpleName(),
