 ...
 */
package de.fraunhofer.iosb.ilt.dataspace.constants;
...
public interface AasConstants {
     ...
     * otherwise with the `edc.aas.exposedFields` configuration
     * variable.
     * <p>
     * Note: In the self-description, some fields are exposed additionally by default. If this is unwanted, the
    ...
    /**
     * To achieve an environment-like structured view of the registered elements, additional fields need to be exposed
     * (e.g., submodelElements of a submodel).
     * <p>
     * This may expose an element "in the middle", i.e. if a submodel(ElementCollection/List) is not registered but a child
     * element of it is, it will be exposed in the
     * self-description. If this is not acceptable due to confidentiality reasons, the self-description should not be
