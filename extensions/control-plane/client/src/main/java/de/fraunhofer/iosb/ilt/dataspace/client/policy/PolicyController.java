...
import static de.fraunhofer.iosb.ilt.dataspace.client.ClientEndpoint.MISSING_REQUEST_BODY_MESSAGE;


/**
 * Provides API for accepted policy management and provider dataset retrieval. For documentation see
 * {@link de.fraunhofer.iosb.ilt.dataspace.client.ClientEndpoint}
 */
