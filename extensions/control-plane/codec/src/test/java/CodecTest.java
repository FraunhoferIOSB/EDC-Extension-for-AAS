...
class CodecTest {
    ...
    private static final EmbeddedRuntime RUNTIME = new EmbeddedRuntime("runtime",
            "org.eclipse.edc:asset-spi",
            "http-spi",
            "policy-spi",
            "contract-spi",
            "transform-lib",
            ...
            "runtime-core",
            "connector-core",
            "edc-connector-client").configurationProvider(
                    () -> ConfigFactory.fromMap(Map.of(
