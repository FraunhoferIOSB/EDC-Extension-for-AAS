 ...
 */
package de.fraunhofer.iosb.ilt.dataspace.app.handler.util;
...
public abstract class MappingHelper {
     ...
     * @param <T> The mappers will have a target type, most likely
     *            {@link org.eclipse.edc.connector.controlplane.asset.spi.domain.Asset Asset}. AAS elements will be mapped
     *            onto that type.
