...
import de.fraunhofer.iosb.ilt.dataspace.edc.remote.stores.asset.RemoteAssetIndex;
import de.fraunhofer.iosb.ilt.dataspace.edc.remote.stores.contract.RemoteContractDefinitionStore;
import de.fraunhofer.iosb.ilt.dataspace.edc.remote.stores.policy.RemotePolicyDefinitionStore;
...
/**
 * EDC service extension that registers remote control-plane store accessors for assets, policies, and contract
 * definitions.
 */
@Provides({
        AssetIndex.class,
